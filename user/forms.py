...
class LoginForm(forms.Form):
    username_or_email=forms.CharField(label='用户名/邮箱',widget=forms.TextInput(attrs={'class':'form-control' , 'placeholder':'请输入用户名/邮箱'}))
...
class RegForm(forms.Form):
    username=forms.CharField(label='用户名',
                            ...
                            widget=forms.TextInput(
                                        attrs={'class':'form-control','placeholder':'请输入3-10位用户名'}))
...
class ChangePasswordForm(forms.Form):
    ...
    new_password_again=forms.CharField(label='新密码',widget=forms.PasswordInput(attrs={'class':'form-control' , 'placeholder':'请再次输入新密码'}))
